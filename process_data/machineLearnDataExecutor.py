...
class MachineLearnDataExecutor:
    def __init__(
        self,
        split_size,
        data_path="",
        ...
        if self.train_data_path and self.test_data_path:
            ...
            self.train_data_x = self.train_data.loc[
                :, self.train_data.columns != "label"
            ]
            ...
            print("no data,must provide data_path or data")
    ...
    def sample(self):
        ...
        print(get_res())
        sample_Executor = RandomUnderSampler(random_state=96)
        self.X, self.label = sample_Executor.fit_resample(self.X, self.label)
...
if __name__ == "__main__":
    ...
    data_ex = MachineLearnDataExecutor(data_path, 0.3, is_sample=True, split=True)
    print(1)
